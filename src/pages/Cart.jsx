...
const Cart = () => {
    ...
    const { cart, deleteProductFromCart } = useProductsStore();   // Получение данных из стора (корзина товаров)
     /**
  ...
  return (
    <section className="cart">
      <div className="max-w-7xl mx-auto px-2">
        <Link
          to="/cards"
          className=" text-indigo-500 hover:text-indigo-600 mb-8 inline-flex mt-6"
        >
